...
<head>
    ...
    <title>Análisis Interactivo XAUUSD - 14 de Julio de 2025</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    <!-- Chosen Palette: Warm Neutrals with Gold & Cool Grey Accents -->
    <!-- Application Structure Plan: A top-down, thematic dashboard structure. It starts with a high-level "Sentiment Dashboard" to show the core market conflict (bull vs. bear). This is followed by a deep-dive "Interactive Technical Analysis" section featuring a main chart with toggleable layers (support, resistance, MAs) and indicator gauges. Next, "Fundamental Factors" are presented in digestible cards. It concludes with actionable "Strategies & Recommendations". This flow guides the user from the general market picture to specific details and finally to conclusions, mimicking a logical analysis process and enhancing usability. New LLM features for "Explain Concept" and "Impact Forecast" are integrated below the technical analysis and as a new section, respectively, to provide on-demand insights. -->
    <!-- Visualization & Content Choices: 
        - Report Info: Overall market sentiment. Goal: Compare. Viz: Two-column Bull/Bear layout with icons (HTML/CSS). Interaction: None. Justification: Provides an immediate, high-level summary of conflicting market forces. Library: Tailwind.
        - Report Info: Historical Price Data. Goal: Show Change. Viz: Line Chart. Interaction: Hover tooltips, toggle buttons for layers. Justification: Best method for time-series data; interactivity transforms it into an analysis tool. Library: Chart.js (Canvas).
        - Report Info: Support/Resistance Levels. Goal: Organize. Viz: Horizontal lines on chart. Interaction: Toggled via buttons. Justification: Provides crucial visual context directly on the price chart, superior to a simple list. Library: Chart.js (Canvas).
        - Report Info: RSI, Fear/Greed Index. Goal: Inform. Viz: Bar-based gauges (HTML/CSS). Interaction: Hover to see value. Justification: Intuitive visual representation of a value within a range. Library: Tailwind/JS.
        - Report Info: Fundamental analysis text. Goal: Organize. Viz: Thematic cards with icons. Interaction: None. Justification: Breaks down complex information into digestible, easy-to-scan sections. Library: Tailwind.
        - Report Info: Trading Strategies. Goal: Inform. Viz: Styled list/cards. Interaction: None. Justification: Clearly presents actionable advice separately from the analysis. Library: Tailwind.
        - New LLM Feature: Explain Concept. Goal: Inform. Viz: Text output in a dedicated section. Interaction: User input text, button click. Justification: Provides on-demand definitions for financial terms, enhancing user understanding. Library: Gemini API.
        - New LLM Feature: Impact Forecast. Goal: Inform/Speculate. Viz: Text output in a dedicated section. Interaction: Dropdown selection, button click. Justification: Offers hypothetical short-term impact analysis based on fundamental factors, adding an interactive analytical layer. Library: Gemini API.
    -->
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const appData = {
            ...
            sentiment: {
                ...
                bearish: [
                    { icon: '💵', text: '<strong>Fortaleza del Dólar (DXY):</strong> El DXY en máximos de un mes encarece el oro para compradores con otras divisas.' },
        ...
        function renderPriceChart() {
            ...
            setupToggle('toggle-support', 'support');
        ...
        const fundamentalSelect = document.getElementById('fundamental-select');
